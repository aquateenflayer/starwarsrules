const LANGUAGE ={
	...
	HUTTESE:{
		NAME:"Huttese",
		DESCRIPTION:"Huttese, the language of the Hutts, was popular among criminals, especially in the (considerable) sections of the galaxy where the Hutt criminal network was powerful."
	}
}